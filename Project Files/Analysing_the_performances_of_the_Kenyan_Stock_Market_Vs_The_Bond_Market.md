...
```
     ...
     <input type="file" id="files-8359fd40-5f4c-4656-8a7d-6f1a54f231a2" name="files[]" multiple disabled
        style="border:none" />
     <output id="result-8359fd40-5f4c-4656-8a7d-6f1a54f231a2">
...
```
  ...
  <div id="df-b3b4307a-26a3-47fc-88f9-653c6a010a0f" class="colab-df-container">
    <div>
<style scoped>
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-b3b4307a-26a3-47fc-88f9-653c6a010a0f')"
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-b3b4307a-26a3-47fc-88f9-653c6a010a0f button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-b3b4307a-26a3-47fc-88f9-653c6a010a0f');
        const dataTable =
...
<div id="df-35f1e207-5644-45f3-a424-f6e18f6aa143">
  <button class="colab-df-quickchart" onclick="quickchart('df-35f1e207-5644-45f3-a424-f6e18f6aa143')"
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-35f1e207-5644-45f3-a424-f6e18f6aa143 button');
...
```
  ...
  <div id="df-a74cf4b2-fe8b-4646-9de7-759549599ef4" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<p>2786 rows × 6 columns</p>
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-a74cf4b2-fe8b-4646-9de7-759549599ef4')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-a74cf4b2-fe8b-4646-9de7-759549599ef4 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-a74cf4b2-fe8b-4646-9de7-759549599ef4');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
<div id="df-e2e3fe36-71e0-47bc-b0ce-de9527ad8e88">
  <button class="colab-df-quickchart" onclick="quickchart('df-e2e3fe36-71e0-47bc-b0ce-de9527ad8e88')"
            title="Suggest charts"
            style="display:none;">
...
<style>
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-e2e3fe36-71e0-47bc-b0ce-de9527ad8e88 button');
      quickchartButtonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
    })();
  </script>
  ...
  <div id="id_e01cdd60-ed28-400a-8a7d-cf362ffca385">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
    ...
    <button class="colab-df-generate" onclick="generateWithVariable('safcom_data')"
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_e01cdd60-ed28-400a-8a7d-cf362ffca385 button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      buttonEl.onclick = () => {
        google.colab.notebook.generateWithVariable('safcom_data');
      }
      })();
    </script>
  </div>
...
```
  ...
  <div id="df-16bd2caa-f991-4e0c-87fc-e47acdcde35f" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<p>2744 rows × 6 columns</p>
</div>
    <div class="colab-df-buttons">

  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-16bd2caa-f991-4e0c-87fc-e47acdcde35f')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-16bd2caa-f991-4e0c-87fc-e47acdcde35f button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-16bd2caa-f991-4e0c-87fc-e47acdcde35f');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
<div id="df-7678d4a5-5e54-4b63-ba4f-004352130f04">
  <button class="colab-df-quickchart" onclick="quickchart('df-7678d4a5-5e54-4b63-ba4f-004352130f04')"
            title="Suggest charts"
            style="display:none;">
...
<style>
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-7678d4a5-5e54-4b63-ba4f-004352130f04 button');
      quickchartButtonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
    })();
  </script>
  ...
  <div id="id_436d1ed1-2988-4243-90f6-f24f787e1568">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_436d1ed1-2988-4243-90f6-f24f787e1568 button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
...
```
  ...
  <div id="df-35ec9f18-69fc-469c-9023-9b1d6cbc78d8" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-35ec9f18-69fc-469c-9023-9b1d6cbc78d8')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-35ec9f18-69fc-469c-9023-9b1d6cbc78d8 button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-35ec9f18-69fc-469c-9023-9b1d6cbc78d8');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
<div id="df-541ccddf-6339-4221-8a58-b771ed3dddd1">
  <button class="colab-df-quickchart" onclick="quickchart('df-541ccddf-6339-4221-8a58-b771ed3dddd1')"
            title="Suggest charts"
            style="display:none;">
...
<style>
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-541ccddf-6339-4221-8a58-b771ed3dddd1 button');
      quickchartButtonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
    })();
  </script>
  ...
  <div id="id_bd110e13-058b-4766-a0a8-76305cea8906">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
    ...
    <button class="colab-df-generate" onclick="generateWithVariable('annual_prices')"
            title="Generate code using this dataframe."
            style="display:none;">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_bd110e13-058b-4766-a0a8-76305cea8906 button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      buttonEl.onclick = () => {
        google.colab.notebook.generateWithVariable('annual_prices');
      }
      })();
    </script>
  </div>
...
```
  ...
  <div id="df-dbe863c4-da32-411b-8143-b41d01a3b9cc" class="colab-df-container">
    <div>
<style scoped>
    .dataframe tbody tr th:only-of-type {
        vertical-align: middle;
...
<table border="1" class="dataframe">
  ...
  <div class="colab-df-container">
    <button class="colab-df-convert" onclick="convertToInteractive('df-dbe863c4-da32-411b-8143-b41d01a3b9cc')"
            title="Convert this dataframe to an interactive table."
            style="display:none;">
  ...
  <style>
    ...
    <script>
      const buttonEl =
        document.querySelector('#df-dbe863c4-da32-411b-8143-b41d01a3b9cc button.colab-df-convert');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      async function convertToInteractive(key) {
        const element = document.querySelector('#df-dbe863c4-da32-411b-8143-b41d01a3b9cc');
        const dataTable =
          await google.colab.kernel.invokeFunction('convertToInteractive',
                                                    [key], {});
        if (!dataTable) return;
...
<div id="df-1257fcda-1d66-4f4c-8176-86d85d69a77b">
  <button class="colab-df-quickchart" onclick="quickchart('df-1257fcda-1d66-4f4c-8176-86d85d69a77b')"
            title="Suggest charts"
            style="display:none;">
...
<style>
  ...
  <script>
    ...
    (() => {
      let quickchartButtonEl =
        document.querySelector('#df-1257fcda-1d66-4f4c-8176-86d85d69a77b button');
      quickchartButtonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';
    })();
  </script>
  ...
  <div id="id_74eed105-f540-4854-8315-1e45032c6272">
    <style>
      .colab-df-generate {
        background-color: #E8F0FE;
        border: none;
    ...
    <button class="colab-df-generate" onclick="generateWithVariable('annualized_yield')"
            title="Generate code using this dataframe."
            style="display:none;">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" height="24px"viewBox="0 0 24 24"
    ...
    <script>
      (() => {
      const buttonEl =
        document.querySelector('#id_74eed105-f540-4854-8315-1e45032c6272 button.colab-df-generate');
      buttonEl.style.display =
        google.colab.kernel.accessAllowed ? 'block' : 'none';

      buttonEl.onclick = () => {
        google.colab.notebook.generateWithVariable('annualized_yield');
      }
      })();
    </script>
  </div>
...
![png](Analysing_the_performances_of_the_Kenyan_Stock_Market_Vs_The_Bond_Market_files/Analysing_the_performances_of_the_Kenyan_Stock_Market_Vs_The_Bond_Market_23_0.png)
...
![png](Analysing_the_performances_of_the_Kenyan_Stock_Market_Vs_The_Bond_Market_files/Analysing_the_performances_of_the_Kenyan_Stock_Market_Vs_The_Bond_Market_24_0.png)
